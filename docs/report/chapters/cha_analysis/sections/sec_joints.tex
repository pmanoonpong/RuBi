...
\label{par:pea_1}
The configuration in \ref{fig:parallel1} 
% paragraph pea_1 (end)
...
\todo{Add parallel spring configuration and explanation}
\todo{Short introduction of benefices and pitfalls of SEA and PEA configurations}
