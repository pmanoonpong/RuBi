...
\centering
  ...
  \begin{subfigure}{.22\textwidth}
    %\centering
    \includegraphics[width=\linewidth]{figures/biobiped.jpg}
    \caption{BioBiped\\
    Lenght = 1.1m\\
    Weight = 10Kg}
...
As an example, the full-range readings from hip, knee and ankle on one leg are shown in Figure \ref{fig:position_measurements}.
