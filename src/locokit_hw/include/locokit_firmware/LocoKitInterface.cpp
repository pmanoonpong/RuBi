...
//#define ROBOT_IP_ADDRESS "192.168.2.2" //"192.168.2.4"//"127.0.0.1"
#define PORT 1214

LocoKitInterface::LocoKitInterface(const char* ip, short int port)
    : ip(ip)
    , port(port)
{
    connected = false;
...
{
    sending_connection.define_client(ip, PORT);
