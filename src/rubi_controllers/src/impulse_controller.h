...
#include "rubi_controllers/impulse_one_leg.h"
#include "rubi_controllers/impulse_two_legs.h"
#include "rubi_controllers/impulse_from_file.h"
#include "rubi_controllers/impulse_controllerConfig.h"
...
class ImpulseController {
 ...
 private:
  ...
  // Dynamic reconfigure
  typedef dynamic_reconfigure::Server<rubi_controllers::impulse_controllerConfig>
