...
ImpulseController::ImpulseController()
  ...
  rubi_controllers::impulse_controllerConfig config;
...
void ImpulseController::resetSimulation() {
  ...
  initial_configuration_msg.request.model_name = "rubi";
  ...
  initial_state_msg.request.model_state.model_name = "rubi";
...
//  spawn_model_msg.request.model_name = "rubi2";
//  spawn_model_msg.request.robot_namespace = "rubi2";
...
void ImpulseController::callbackDynamicParameters(
    rubi_controllers::impulse_controllerConfig &config, uint32_t level) {
...
bool ImpulseController::callbackServiceImpulseOneLeg(
    rubi_controllers::impulse_one_leg::Request &req,
    rubi_controllers::impulse_one_leg::Response &res) {
...
bool ImpulseController::callbackServiceImpulseTwoLegs(
    rubi_controllers::impulse_two_legs::Request &req,
    rubi_controllers::impulse_two_legs::Response &res) {
...
bool ImpulseController::callbackServiceImpulseFromFile(
    rubi_controllers::impulse_from_file::Request &req,
    rubi_controllers::impulse_from_file::Response &res) {
  // Reads the file
  YAML::Node file;
  if (!req.path_to_file.empty())
    file = YAML::LoadFile(req.path_to_file);
  else
    file = YAML::LoadFile(ros::package::getPath("rubi_controllers") +
