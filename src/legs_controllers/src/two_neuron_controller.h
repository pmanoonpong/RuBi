...
#include "legs_controllers/two_neuronConfig.h"
...
class TwoNeuronController {
 public:
   ...
   * @param level
   */
  void callbackDynamicParameters(legs_controller::two_neuronConfig& config,
                                 uint32_t level);
 ...
 private:
  ...
  // Dynamic reconfigure
  typedef dynamic_reconfigure::Server<legs_controller::two_neuronConfig>
