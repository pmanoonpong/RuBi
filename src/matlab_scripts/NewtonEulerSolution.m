...
r2c3 = (Positions(:,4)-Positions(:,3))*mP;
r3c3 = (Positions(:,3)-Positions(:,4))*(1-mP);
...
r1c2 = (Positions(:,3)-Positions(:,2))*mP;
r2c2 = (Positions(:,2)-Positions(:,3))*(1-mP);
...
r0c1 = (Positions(:,2)-Positions(:,1))*(mP);
r1c1 = (Positions(:,2)-Positions(:,1))*(1-mP);
